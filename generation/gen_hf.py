...
# few_shot_cot_prompt = instruct_prompt + '\n' + example + f'\nQuestion: '  
few_shot_cot_prompt = instruct_prompt + f'Question: ' 

def preprocess(sample):
    sample["prompt"] = f'Question: ' + sample['question']
    sample["prompt_with_ct"] = tokenizer.apply_chat_template([{"role": "user", "content": few_shot_cot_prompt + sample['question']}], tokenize = False, add_generation_prompt= True)
